...
import 'package:smart_canvas/features/student/study_chatbot/views/widgets/chat_input_bar.dart';
import 'package:smart_canvas/features/student/study_chatbot/views/widgets/messages_list_view.dart';

class StudyChatbotScreenBody extends StatelessWidget {
  const StudyChatbotScreenBody({super.key});

  @override
  Widget build(BuildContext context) {
    var cubit = context.read<StudyChatbotCubit>();
    final isDark = Theme.of(context).brightness == Brightness.dark;

    return BlocListener<StudyChatbotCubit, StudyChatbotState>(
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(LineIcons.robot, color: AppColors.kPrimaryColor, size: 18),
              ),
      ...
      body: Column(
        children: [
          Expanded(child: MessagesListView(cubit: cubit)),
          ChatInputBar(cubit: cubit),
  ...
  void _showClearConfirmation(BuildContext context, StudyChatbotCubit cubit) {
    showDialog(
      context: context,
  ...
  Widget _buildHistoryDrawer(BuildContext context, StudyChatbotCubit cubit, bool isDark) {
    return Drawer(
      ...
      child: SafeArea(
        child: Column(
          children: [
            ...
            // Custom Solid Gradient New Chat Button
            Padding(
            ...
            // Sessions List
            Expanded(
              child: BlocBuilder<StudyChatbotCubit, StudyChatbotState>(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  // Selected Accent Line Indicator
                                  if (isSelected)
                                    Container(
                                      width: 3.5,
                                      height: 18,
  ...
  void _showDeleteSessionConfirmation(BuildContext context, StudyChatbotCubit cubit, String sessionId) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
