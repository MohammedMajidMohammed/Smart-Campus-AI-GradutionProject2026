...
class SelectYearLevel extends StatelessWidget {
  const SelectYearLevel({
    super.key,
    required this.cubit,
  });
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SignUpCubit, SignUpState>(
      ...
      builder: (context, state) {
        if (cubit.availableYearLevels.isEmpty) {
        ...
        return Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: cubit.availableYearLevels.map((year) {
                final isSelected = cubit.yearLevel == year;
                return ChoiceChip(
                  ...
                  onSelected: (_) => cubit.selectYearLevel(year),
