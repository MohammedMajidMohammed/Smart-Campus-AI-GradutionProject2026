...
import 'package:smart_canvas/features/administrator/buildings/views/widgets/add_building_form.dart';

class AddBuildingModalBottomSheetBody extends StatelessWidget {
  const AddBuildingModalBottomSheetBody({super.key});

  @override
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    
    return BlocListener<AddBuildingCubit, AddBuildingState>(
      listener: (context, state) {
        ...
        // ... (other warning listeners remain same or simplified)
      },
