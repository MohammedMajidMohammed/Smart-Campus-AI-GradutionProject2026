...
import 'package:smart_canvas/features/administrator/dashboard/views/widgets/administrator_action_card.dart';

class AdministratorActionGridView extends StatelessWidget {
    ...
    return Center(
      child: ConstrainedBox(
        ...
        child: GridView.builder(
          ...
          itemCount: AppConstants.administratorActions.length,
          itemBuilder: (context, index) => AnimatedCard(
            delay: Duration(milliseconds: 80 * index),
            onTap: () {
              context.pushScreen(AppConstants.administratorActions[index].route);
            },
            child: AdministratorActionCard(
              administratorActionModel:
                  AppConstants.administratorActions[index],
            ),
          ),
        ),
      ),
