...
class ProfessorSchedulesScreenBody extends StatefulWidget {
  const ProfessorSchedulesScreenBody({super.key});

  @override
  State<ProfessorSchedulesScreenBody> createState() => _ProfessorSchedulesScreenBodyState();
}

class _ProfessorSchedulesScreenBodyState extends State<ProfessorSchedulesScreenBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => ProfessorScheduleCubit(),
      child: Scaffold(
          ...
          actions: [
            // View Toggle Button
             IconButton(
              ...
              tooltip: _isTableView ? "Switch to Timeline View" : "Switch to Table View",
            ),
            const SizedBox(width: 8),
          ],
        ),
        body: BlocBuilder<ProfessorScheduleCubit, SchedulesState>(
          builder: (context, state) {
            ...
            if (_isTableView) {
              return _GridScheduleView(
                schedules: cubit.filteredSchedules,
                isTablet: isTablet,
              );
            }
            ...
            return Column(
              children: [
                ...
                Container(
                  ...
                  child: BlocBuilder<ProfessorScheduleCubit, SchedulesState>(
                    builder: (context, state) {
                ...
                Expanded(
                  child: Builder(
                    builder: (context) {
                      ...
                      final daySchedules = cubit.filteredSchedules.where((s) {
                              ...
                              children: [
                                ...
                                ElevatedButton.icon(
                                    ...
                                    await Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => QrAttendanceScreen(
                                          preselectedSubjectId: model.subject?.id ?? "",
                                        ),
                                      ),
                                    );
                                  },
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    foregroundColor: isDark ? const Color(0xFF0F0E0A) : Colors.white,
                                  ...
                                  icon: isDark 
                                      ? const Icon(Icons.qr_code_scanner_rounded, size: 16, color: Color(0xFF0F0E0A))
