...
_FNAME_PROG_MAP = [
    (["حاسب", "حاسوب", "computer", "cs", "it", "ذكاء", "informatics"],
     "computer science"),
    (["أسنان", "اسنان", "dent"],                "dentistry"),
    # More specific matches BEFORE general ones
    (["طب بيطري", "veterinar", "bitar"],         "veterinary"),
    (["علاج طبيعي", "علاج_طبيعي", "physical therapy", "physio"], "physical therapy"),
    (["طب", "medicine", "medical", "mbbs"],      "medicine"),
    (["هندس", "engineer"],                       "engineering"),
    (["صيدل", "pharmac"],                        "pharmacy"),
    (["تمريض", "nursing"],                       "nursing"),
    (["حقوق", "قانون", "law"],                   "law"),
    (["تجار", "commerce", "business"],           "commerce"),
    (["لغة إنجليزية", "لغه انجليزيه", "لغه برنامج",
      "english", "translation", "ترجمة", "ترجمه"], "arts"),
]
